...
var SlotGrimGang = (function (_super) {
    __extends(SlotGrimGang, _super);
    function SlotGrimGang() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_ICON = 'grimgang/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_ICON_ANIM = 'grimgang/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_HELP_SCENE = 'grimgang/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_MAIN_SCENE = 'grimgang/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_RECT = 'gnome/images/rect_mc.json';
        SlotEnity.NAME_ATLAS_ICON_1 = 'grimgang/images/img_v2/game/anim_main/icon_1.json';
        SlotEnity.NAME_ATLAS_ICON_4 = 'grimgang/images/img_v2/game/anim_main/icon_4.json';
        SlotEnity.NAME_ATLAS_ICON_6 = 'grimgang/images/img_v2/game/anim_main/icon_6.json';
        SlotEnity.NAME_ATLAS_ICON_9 = 'grimgang/images/img_v2/game/anim_main/icon_9.json';
        SlotEnity.NAME_ATLAS_ICONS = 'grimgang/images/img_v2/game/anim_main/icons.json';
    ...
    SlotGrimGang.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'grimgang/images/img_v2/game/mainback_GrimGang.jpg?2')
            .add('grimgang/images/img_v2/game/prokrut_main/icon_main.json')
            .add('double', 'grimgang/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'grimgang/images/img_v2/help/help.jpg?1')
            .add('help_scene_0', 'grimgang/images/img_v2/help/help0.jpg?1')
            .add('help_scene_1', 'grimgang/images/img_v2/help/help1.jpg?1')
            .add('help_scene_2', 'grimgang/images/img_v2/help/help2.jpg?1')
            ...
            .add('grimgang/images/img_v2/game/anim_main/icon_1.json')
            .add('grimgang/images/img_v2/game/anim_main/icon_4.json')
            .add('grimgang/images/img_v2/game/anim_main/icon_6.json')
            .add('grimgang/images/img_v2/game/anim_main/icon_9.json')
            .add('grimgang/images/img_v2/game/anim_main/icons.json');
        this.loader.once("complete", callback, this);
        this.loader.on('progress', this.onProgressCallback, this);
        this.loader.load();
    };
    SlotGrimGang.prototype.onProgressCallback = function (e, r) {
        console.log(e.progress + " | " + r.name);
    };
    SlotGrimGang.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotGrimGang.prototype.getSettingRoll = function () {
    ...
    SlotGrimGang.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotGrimGang.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneGrimGang();
        return this.help;
    };
    SlotGrimGang.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneGrimGang();
        return this.gamble;
    };
    SlotGrimGang.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneGrimGang();
        return this.mainScene;
    };
    SlotGrimGang.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotGrimGang;
}(SlotEnity));
var MainSceneGrimGang = (function (_super) {
    __extends(MainSceneGrimGang, _super);
    function MainSceneGrimGang() {
    ...
    MainSceneGrimGang.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneGrimGang.prototype.getAnimIconVOForId = function (id) {
    ...
    MainSceneGrimGang.prototype.completeShowLines = function () {
    };
    MainSceneGrimGang.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneGrimGang.prototype.exchangeMode = function (value) {
    ...
    MainSceneGrimGang.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneGrimGang.prototype.updateBetLine = function (type) {
    ...
    MainSceneGrimGang.prototype.updateShield = function () {
    ...
    MainSceneGrimGang.prototype.getNumBonus = function () {
    ...
    return MainSceneGrimGang;
}(MainScene));
var HelpSceneGrimGang = (function (_super) {
    __extends(HelpSceneGrimGang, _super);
    function HelpSceneGrimGang() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneGrimGang;
}(HelpScene));
var GambleSceneGrimGang = (function (_super) {
    __extends(GambleSceneGrimGang, _super);
    function GambleSceneGrimGang() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneGrimGang.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneGrimGang.prototype.exchangeMode = function (value) {
    ...
    GambleSceneGrimGang.prototype.showMsgDouble = function () {
        mainSlot.panel.panel.setTxtInfo("SELECT CARD OR START");
    };
    GambleSceneGrimGang.prototype.setSelectValue = function (type) {
        _super.prototype.setSelectValue.call(this, type);
        this.pick_mc.x = this.mc["card" + type].x + 82;
        this.pick_mc.visible = true;
    };
    GambleSceneGrimGang.prototype.resetGamble = function () {
        var _this = this;
    ...
    GambleSceneGrimGang.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneGrimGang;
}(GambleScene));
var BonusSceneGrimGang = (function (_super) {
    __extends(BonusSceneGrimGang, _super);
    function BonusSceneGrimGang() {
        var _this = this;
    ...
    BonusSceneGrimGang.prototype.initDisplay = function () {
    };
    BonusSceneGrimGang.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneGrimGang.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneGrimGang.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneGrimGang.prototype.selectBonus = function (nom) {
    ...
    BonusSceneGrimGang.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneGrimGang;
}(BonusScene));
var slotGrimGang = new SlotGrimGang();
mainSlot.setSlot(slotGrimGang);
//# sourceMappingURL=slot_grimgang.js.map