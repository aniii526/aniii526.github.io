class SlotGrimGang extends SlotEnity implements ISlotEnity {
...
class MainSceneGrimGang extends MainScene implements IMainScene {
...
class HelpSceneGrimGang extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneGrimGang extends GambleScene implements IGambleScene {
...
class BonusSceneGrimGang extends BonusScene implements IBonusScene {
...
//TO DO
var slotGrimGang: SlotGrimGang = new SlotGrimGang();
