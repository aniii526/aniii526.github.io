...
var SlotHorde = (function (_super) {
    __extends(SlotHorde, _super);
    function SlotHorde() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/horde/images/img_v2/game/iconsss.json';
    ...
    SlotHorde.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/horde/images/img_v2/game/mainback_Horde.jpg?2')
            .add('double', 'games/horde/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/horde/images/img_v2/help/help.jpg?1')
    ...
    SlotHorde.prototype.onProgressCallback = function (e, r) {
    };
    SlotHorde.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotHorde.prototype.getSettingRoll = function () {
    ...
    SlotHorde.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotHorde.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneHorde();
        return this.help;
    };
    SlotHorde.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneHorde();
        return this.gamble;
    };
    SlotHorde.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneHorde();
        return this.mainScene;
    };
    SlotHorde.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotHorde;
}(SlotEnity));
var MainSceneHorde = (function (_super) {
    __extends(MainSceneHorde, _super);
    function MainSceneHorde() {
    ...
    MainSceneHorde.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneHorde.prototype.getAnimIconVOForId = function (id) {
    ...
    MainSceneHorde.prototype.completeShowLines = function () {
    };
    MainSceneHorde.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneHorde.prototype.exchangeMode = function (value) {
    ...
    MainSceneHorde.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneHorde.prototype.updateBetLine = function (type) {
    ...
    MainSceneHorde.prototype.updateShield = function () {
    ...
    MainSceneHorde.prototype.getNumBonus = function () {
    ...
    return MainSceneHorde;
}(MainScene));
var HelpSceneHorde = (function (_super) {
    __extends(HelpSceneHorde, _super);
    function HelpSceneHorde() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneHorde;
}(HelpScene));
var GambleSceneHorde = (function (_super) {
    __extends(GambleSceneHorde, _super);
    function GambleSceneHorde() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneHorde.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneHorde.prototype.exchangeMode = function (value) {
    ...
    GambleSceneHorde.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneHorde;
}(GambleScene));
var BonusSceneHorde = (function (_super) {
    __extends(BonusSceneHorde, _super);
    function BonusSceneHorde() {
        var _this = this;
    ...
    BonusSceneHorde.prototype.initDisplay = function () {
    };
    BonusSceneHorde.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneHorde.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneHorde.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneHorde.prototype.selectBonus = function (nom) {
    ...
    BonusSceneHorde.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneHorde;
}(BonusScene));
var slotHorde = new SlotHorde();
mainSlot.setSlot(slotHorde);
//# sourceMappingURL=slot_horde.js.map