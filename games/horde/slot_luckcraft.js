...
var SlotLuckCraft = (function (_super) {
    __extends(SlotLuckCraft, _super);
    function SlotLuckCraft() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_ICON = 'games/luckcraft/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_ICON_ANIM = 'games/luckcraft/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_HELP_SCENE = 'games/luckcraft/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_MAIN_SCENE = 'games/luckcraft/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_RECT = 'games/gnome/images/rect_mc.json';
        SlotEnity.NAME_ATLAS_ICON_6 = 'games/luckcraft/images/img_v2/game/anim_main/icon_6.json';
        SlotEnity.NAME_ATLAS_ICON_7 = 'games/luckcraft/images/img_v2/game/anim_main/icon_7.json';
        SlotEnity.NAME_ATLAS_ICON_8 = 'games/luckcraft/images/img_v2/game/anim_main/icon_8.json';
        SlotEnity.NAME_ATLAS_ICON_9 = 'games/luckcraft/images/img_v2/game/anim_main/icon_9.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/luckcraft/images/img_v2/game/anim_main/icons.json';
    ...
    SlotLuckCraft.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/luckcraft/images/img_v2/game/mainback_LuckCraft.jpg?2')
            .add('games/luckcraft/images/img_v2/game/prokrut_main/icon_main.json')
            .add('double', 'games/luckcraft/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/luckcraft/images/img_v2/help/help.jpg?1')
            .add('help_scene_0', 'games/luckcraft/images/img_v2/help/help0.jpg?1')
            .add('help_scene_1', 'games/luckcraft/images/img_v2/help/help1.jpg?1')
            .add('help_scene_2', 'games/luckcraft/images/img_v2/help/help2.jpg?1')
            ...
            .add('games/luckcraft/images/img_v2/game/anim_main/icon_6.json')
            .add('games/luckcraft/images/img_v2/game/anim_main/icon_7.json')
            .add('games/luckcraft/images/img_v2/game/anim_main/icon_8.json')
            .add('games/luckcraft/images/img_v2/game/anim_main/icon_9.json')
            .add('games/luckcraft/images/img_v2/game/anim_main/icons.json');
        this.loader.once("complete", callback, this);
        this.loader.on('progress', this.onProgressCallback, this);
        this.loader.load();
    };
    SlotLuckCraft.prototype.onProgressCallback = function (e, r) {
    };
    SlotLuckCraft.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotLuckCraft.prototype.getSettingRoll = function () {
    ...
    SlotLuckCraft.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotLuckCraft.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneLuckCraft();
        return this.help;
    };
    SlotLuckCraft.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneLuckCraft();
        return this.gamble;
    };
    SlotLuckCraft.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneLuckCraft();
        return this.mainScene;
    };
    SlotLuckCraft.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotLuckCraft;
}(SlotEnity));
var MainSceneLuckCraft = (function (_super) {
    __extends(MainSceneLuckCraft, _super);
    function MainSceneLuckCraft() {
        _super.call(this, new PIXI.Sprite());
        this.soundsManifest = [
            { src: "games/gnome/sounds/addline.mp3?1473506394550", id: "addline" },
            { src: "games/gnome/sounds/b1_loss.mp3?1473506394550", id: "b1_loss" },
            { src: "games/gnome/sounds/b1_open.mp3?1473506394550", id: "b1_open" },
            { src: "games/gnome/sounds/b1_win.mp3?1473506394550", id: "b1_win" },
            { src: "games/gnome/sounds/bonus.mp3?1473506394550", id: "bonus" },
            { src: "games/gnome/sounds/card_dealer_open.mp3?1473506394550", id: "card_dealer_open" },
            { src: "games/gnome/sounds/cardwin.mp3?1473506394550", id: "cardwin" },
            { src: "games/gnome/sounds/key_press.mp3?1473506394550", id: "key_press" },
            { src: "games/gnome/sounds/money_move.mp3?1473506394550", id: "money_move" },
            { src: "games/gnome/sounds/route1time.mp3?1473506394551", id: "route1time" },
            { src: "games/gnome/sounds/routestop.mp3?1473506394551", id: "routestop" },
            { src: "games/gnome/sounds/sb_loss.mp3?1473506394551", id: "sb_loss" }
        ];
    ...
    MainSceneLuckCraft.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneLuckCraft.prototype.getAnimIconVOForId = function (id) {
        ...
        switch (id) {
            ...
            case 5:
                ...
                break;
            case 6:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICON_6, "icon_6_", 11);
                animIconVO.loop = false;
                animIconVO.anim_speed = 6 / 60;
                break;
            case 7:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICON_7, "icon_7_", 11);
                animIconVO.loop = false;
                animIconVO.anim_speed = 6 / 60;
                break;
            case 8:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICON_8, "icon_8_", 15);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
            case 9:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICON_9, "icon_9_", 15);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
        }
    ...
    MainSceneLuckCraft.prototype.completeShowLines = function () {
    };
    MainSceneLuckCraft.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneLuckCraft.prototype.exchangeMode = function (value) {
    ...
    MainSceneLuckCraft.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneLuckCraft.prototype.updateBetLine = function (type) {
    ...
    MainSceneLuckCraft.prototype.updateShield = function () {
    ...
    MainSceneLuckCraft.prototype.getNumBonus = function () {
    ...
    return MainSceneLuckCraft;
}(MainScene));
var HelpSceneLuckCraft = (function (_super) {
    __extends(HelpSceneLuckCraft, _super);
    function HelpSceneLuckCraft() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneLuckCraft;
}(HelpScene));
var GambleSceneLuckCraft = (function (_super) {
    __extends(GambleSceneLuckCraft, _super);
    function GambleSceneLuckCraft() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneLuckCraft.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneLuckCraft.prototype.exchangeMode = function (value) {
    ...
    GambleSceneLuckCraft.prototype.showMsgDouble = function () {
        mainSlot.panel.panel.setTxtInfo("SELECT CARD OR START");
    };
    GambleSceneLuckCraft.prototype.setSelectValue = function (type) {
        _super.prototype.setSelectValue.call(this, type);
        this.pick_mc.x = this.mc["card" + type].x + 82;
        this.pick_mc.visible = true;
    };
    GambleSceneLuckCraft.prototype.resetGamble = function () {
        var _this = this;
    ...
    GambleSceneLuckCraft.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneLuckCraft;
}(GambleScene));
var BonusSceneLuckCraft = (function (_super) {
    __extends(BonusSceneLuckCraft, _super);
    function BonusSceneLuckCraft() {
        var _this = this;
    ...
    BonusSceneLuckCraft.prototype.initDisplay = function () {
    };
    BonusSceneLuckCraft.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneLuckCraft.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneLuckCraft.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneLuckCraft.prototype.selectBonus = function (nom) {
    ...
    BonusSceneLuckCraft.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneLuckCraft;
}(BonusScene));
var slotLuckCraft = new SlotLuckCraft();
mainSlot.setSlot(slotLuckCraft);
//# sourceMappingURL=slot_luckcraft.js.map