class SlotHorde extends SlotEnity implements ISlotEnity {
...
class MainSceneHorde extends MainScene implements IMainScene {
...
class HelpSceneHorde extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneHorde extends GambleScene implements IGambleScene {
...
class BonusSceneHorde extends BonusScene implements IBonusScene {
...
//TO DO
var slotHorde: SlotHorde = new SlotHorde();
