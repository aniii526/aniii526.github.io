...
var SlotLordOfLuck = (function (_super) {
    ...
    function SlotLordOfLuck() {
        ...
        SlotEnity.NAME_ATLAS_ICONS = 'games/lordofluck/images/img_v2/game/iconsss.json';
    ...
    SlotLordOfLuck.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/lordofluck/images/img_v2/game/mainback_LordOfLuck.jpg?2')
            .add('double', 'games/lordofluck/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/lordofluck/images/img_v2/help/help.jpg?1')
