...
var SlotRevengers = (function (_super) {
    ...
    function SlotRevengers() {
        ...
        SlotEnity.NAME_ATLAS_ICONS = 'games/revengers/images/img_v2/game/iconsss.json';
    ...
    SlotRevengers.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/revengers/images/img_v2/game/mainback_REvengers.jpg?2')
            .add('double', 'games/revengers/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/revengers/images/img_v2/help/help.jpg?1')
