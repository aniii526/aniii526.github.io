...
var SlotPandora = (function (_super) {
    __extends(SlotPandora, _super);
    function SlotPandora() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/pandora/images/img_v2/game/iconsss.json';
    ...
    SlotPandora.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/pandora/images/img_v2/game/mainback_Pandora.jpg?2')
            .add('double', 'games/pandora/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/pandora/images/img_v2/help/help.jpg?1')
    ...
    SlotPandora.prototype.onProgressCallback = function (e, r) {
    };
    SlotPandora.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotPandora.prototype.getSettingRoll = function () {
    ...
    SlotPandora.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotPandora.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpScenePandora();
        return this.help;
    };
    SlotPandora.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleScenePandora();
        return this.gamble;
    };
    SlotPandora.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainScenePandora();
        return this.mainScene;
    };
    SlotPandora.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotPandora;
}(SlotEnity));
var MainScenePandora = (function (_super) {
    __extends(MainScenePandora, _super);
    function MainScenePandora() {
    ...
    MainScenePandora.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainScenePandora.prototype.getAnimIconVOForId = function (id) {
        var animIconVO = new AnimIconVO();
        animIconVO.anim_speed = 4 / 60;
        switch (id) {
            case 1:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_1_", 4);
                animIconVO.loop = true;
                break;
            case 2:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_2_", 4);
                animIconVO.loop = true;
                break;
            case 3:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_3_", 4);
                animIconVO.loop = true;
                break;
            case 4:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_4_", 4);
                animIconVO.loop = true;
                break;
            case 5:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_5_", 4);
                animIconVO.loop = true;
                break;
            case 6:
    ...
    MainScenePandora.prototype.completeShowLines = function () {
    };
    MainScenePandora.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainScenePandora.prototype.exchangeMode = function (value) {
    ...
    MainScenePandora.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainScenePandora.prototype.updateBetLine = function (type) {
    ...
    MainScenePandora.prototype.updateShield = function () {
    ...
    MainScenePandora.prototype.getNumBonus = function () {
    ...
    return MainScenePandora;
}(MainScene));
var HelpScenePandora = (function (_super) {
    __extends(HelpScenePandora, _super);
    function HelpScenePandora() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpScenePandora;
}(HelpScene));
var GambleScenePandora = (function (_super) {
    __extends(GambleScenePandora, _super);
    function GambleScenePandora() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleScenePandora.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleScenePandora.prototype.exchangeMode = function (value) {
    ...
    GambleScenePandora.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleScenePandora;
}(GambleScene));
var BonusScenePandora = (function (_super) {
    __extends(BonusScenePandora, _super);
    function BonusScenePandora() {
        var _this = this;
    ...
    BonusScenePandora.prototype.initDisplay = function () {
    };
    BonusScenePandora.prototype.onCompleteAnimation = function () {
    ...
    BonusScenePandora.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusScenePandora.prototype.setPositionGnome = function (pos) {
    ...
    BonusScenePandora.prototype.selectBonus = function (nom) {
    ...
    BonusScenePandora.prototype.setBombForShield = function (isRand) {
    ...
    return BonusScenePandora;
}(BonusScene));
var slotPandora = new SlotPandora();
mainSlot.setSlot(slotPandora);
//# sourceMappingURL=slot_pandora.js.map