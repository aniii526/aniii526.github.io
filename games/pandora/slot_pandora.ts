class SlotPandora extends SlotEnity implements ISlotEnity {
...
class MainScenePandora extends MainScene implements IMainScene {
...
class HelpScenePandora extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleScenePandora extends GambleScene implements IGambleScene {
...
class BonusScenePandora extends BonusScene implements IBonusScene {
...
//TO DO
var slotPandora: SlotPandora = new SlotPandora();
