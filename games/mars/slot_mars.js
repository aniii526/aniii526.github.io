...
var SlotMars = (function (_super) {
    __extends(SlotMars, _super);
    function SlotMars() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/mars/images/img_v2/game/iconsss.json';
    ...
    SlotMars.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/mars/images/img_v2/game/mainback_Mars.jpg?2')
            .add('double', 'games/mars/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/mars/images/img_v2/help/help.jpg?1')
    ...
    SlotMars.prototype.onProgressCallback = function (e, r) {
    };
    SlotMars.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotMars.prototype.getSettingRoll = function () {
    ...
    SlotMars.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotMars.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneMars();
        return this.help;
    };
    SlotMars.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneMars();
        return this.gamble;
    };
    SlotMars.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneMars();
        return this.mainScene;
    };
    SlotMars.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotMars;
}(SlotEnity));
var MainSceneMars = (function (_super) {
    __extends(MainSceneMars, _super);
    function MainSceneMars() {
    ...
    MainSceneMars.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneMars.prototype.getAnimIconVOForId = function (id) {
        ...
        switch (id) {
            ...
            case 5:
                ...
                break;
            case 6:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_6_", 10);
    ...
    MainSceneMars.prototype.completeShowLines = function () {
    };
    MainSceneMars.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneMars.prototype.exchangeMode = function (value) {
    ...
    MainSceneMars.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneMars.prototype.updateBetLine = function (type) {
    ...
    MainSceneMars.prototype.updateShield = function () {
    ...
    MainSceneMars.prototype.getNumBonus = function () {
    ...
    return MainSceneMars;
}(MainScene));
var HelpSceneMars = (function (_super) {
    __extends(HelpSceneMars, _super);
    function HelpSceneMars() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneMars;
}(HelpScene));
var GambleSceneMars = (function (_super) {
    __extends(GambleSceneMars, _super);
    function GambleSceneMars() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneMars.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneMars.prototype.exchangeMode = function (value) {
    ...
    GambleSceneMars.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneMars;
}(GambleScene));
var BonusSceneMars = (function (_super) {
    __extends(BonusSceneMars, _super);
    function BonusSceneMars() {
        var _this = this;
    ...
    BonusSceneMars.prototype.initDisplay = function () {
    };
    BonusSceneMars.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneMars.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneMars.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneMars.prototype.selectBonus = function (nom) {
    ...
    BonusSceneMars.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneMars;
}(BonusScene));
var slotMars = new SlotMars();
mainSlot.setSlot(slotMars);
//# sourceMappingURL=slot_mars.js.map