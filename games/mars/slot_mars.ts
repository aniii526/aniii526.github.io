class SlotMars extends SlotEnity implements ISlotEnity {
...
class MainSceneMars extends MainScene implements IMainScene {
...
class HelpSceneMars extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneMars extends GambleScene implements IGambleScene {
...
class BonusSceneMars extends BonusScene implements IBonusScene {
...
//TO DO
var slotMars: SlotMars = new SlotMars();
