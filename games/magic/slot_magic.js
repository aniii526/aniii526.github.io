...
var SlotMagic = (function (_super) {
    __extends(SlotMagic, _super);
    function SlotMagic() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/magic/images/img_v2/game/iconsss.json';
    ...
    SlotMagic.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/magic/images/img_v2/game/mainback_Magic.jpg?3')
            .add('double', 'games/magic/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/magic/images/img_v2/help/help.jpg?1')
    ...
    SlotMagic.prototype.onProgressCallback = function (e, r) {
    };
    SlotMagic.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotMagic.prototype.getSettingRoll = function () {
    ...
    SlotMagic.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotMagic.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneMagic();
        return this.help;
    };
    SlotMagic.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneMagic();
        return this.gamble;
    };
    SlotMagic.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneMagic();
        return this.mainScene;
    };
    SlotMagic.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotMagic;
}(SlotEnity));
var MainSceneMagic = (function (_super) {
    __extends(MainSceneMagic, _super);
    function MainSceneMagic() {
    ...
    MainSceneMagic.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneMagic.prototype.getAnimIconVOForId = function (id) {
    ...
    MainSceneMagic.prototype.completeShowLines = function () {
    };
    MainSceneMagic.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneMagic.prototype.exchangeMode = function (value) {
    ...
    MainSceneMagic.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneMagic.prototype.updateBetLine = function (type) {
    ...
    MainSceneMagic.prototype.updateShield = function () {
    ...
    MainSceneMagic.prototype.getNumBonus = function () {
    ...
    return MainSceneMagic;
}(MainScene));
var HelpSceneMagic = (function (_super) {
    __extends(HelpSceneMagic, _super);
    function HelpSceneMagic() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneMagic;
}(HelpScene));
var GambleSceneMagic = (function (_super) {
    __extends(GambleSceneMagic, _super);
    function GambleSceneMagic() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneMagic.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneMagic.prototype.exchangeMode = function (value) {
    ...
    GambleSceneMagic.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneMagic;
}(GambleScene));
var BonusSceneMagic = (function (_super) {
    __extends(BonusSceneMagic, _super);
    function BonusSceneMagic() {
        var _this = this;
    ...
    BonusSceneMagic.prototype.initDisplay = function () {
    };
    BonusSceneMagic.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneMagic.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneMagic.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneMagic.prototype.selectBonus = function (nom) {
    ...
    BonusSceneMagic.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneMagic;
}(BonusScene));
var slotMagic = new SlotMagic();
mainSlot.setSlot(slotMagic);
//# sourceMappingURL=slot_magic.js.map