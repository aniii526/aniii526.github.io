class SlotMagic extends SlotEnity implements ISlotEnity {
...
class MainSceneMagic extends MainScene implements IMainScene {
...
class HelpSceneMagic extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneMagic extends GambleScene implements IGambleScene {
...
class BonusSceneMagic extends BonusScene implements IBonusScene {
...
//TO DO
var slotMagic: SlotMagic = new SlotMagic();
