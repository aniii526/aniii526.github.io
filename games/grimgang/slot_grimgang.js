...
var SlotGrimGang = (function (_super) {
    ...
    function SlotGrimGang() {
        ...
        SlotEnity.NAME_ATLAS_ICONS = 'games/grimgang/images/img_v2/game/iconsss.json';
    ...
    SlotGrimGang.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/grimgang/images/img_v2/game/mainback_GrimGang.jpg?2')
            .add('double', 'games/grimgang/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'games/grimgang/images/img_v2/help/help.jpg?1')
    ...
    MainSceneGrimGang.prototype.getAnimIconVOForId = function (id) {
        ...
        switch (id) {
            ...
            case 5:
                ...
                break;
            case 6:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_6_", 16);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
            case 7:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_7_", 16);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
            case 8:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_8_", 16);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
            case 9:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_9_", 16);
                animIconVO.loop = false;
                animIconVO.anim_speed = 8 / 60;
                break;
        }
