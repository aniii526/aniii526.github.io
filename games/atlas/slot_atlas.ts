class SlotAtlas extends SlotEnity implements ISlotEnity {
...
class MainSceneAtlas extends MainScene implements IMainScene {
...
class HelpSceneAtlas extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneAtlas extends GambleScene implements IGambleScene {
...
class BonusSceneAtlas extends BonusScene implements IBonusScene {
...
//TO DO
var slotAtlas: SlotAtlas = new SlotAtlas();
