...
var SlotGuards = (function (_super) {
    __extends(SlotGuards, _super);
    function SlotGuards() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/guards/images/img_v2/game/iconsss.json';
    ...
    SlotGuards.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/guards/images/img_v2/game/mainback_Guards.jpg?2')
            .add('double', 'games/guards/images/img_v2/gamble/double.png?1')
            .add('help_bg', 'games/guards/images/img_v2/help/help.png?1')
    ...
    SlotGuards.prototype.onProgressCallback = function (e, r) {
    };
    SlotGuards.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotGuards.prototype.getSettingRoll = function () {
    ...
    SlotGuards.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotGuards.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneGuards();
        return this.help;
    };
    SlotGuards.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneGuards();
        return this.gamble;
    };
    SlotGuards.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneGuards();
        return this.mainScene;
    };
    SlotGuards.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotGuards;
}(SlotEnity));
var MainSceneGuards = (function (_super) {
    __extends(MainSceneGuards, _super);
    function MainSceneGuards() {
    ...
    MainSceneGuards.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneGuards.prototype.getAnimIconVOForId = function (id) {
    ...
    MainSceneGuards.prototype.completeShowLines = function () {
    };
    MainSceneGuards.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneGuards.prototype.exchangeMode = function (value) {
    ...
    MainSceneGuards.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneGuards.prototype.updateBetLine = function (type) {
    ...
    MainSceneGuards.prototype.updateShield = function () {
    ...
    MainSceneGuards.prototype.getNumBonus = function () {
    ...
    return MainSceneGuards;
}(MainScene));
var HelpSceneGuards = (function (_super) {
    __extends(HelpSceneGuards, _super);
    function HelpSceneGuards() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneGuards;
}(HelpScene));
var GambleSceneGuards = (function (_super) {
    __extends(GambleSceneGuards, _super);
    function GambleSceneGuards() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneGuards.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneGuards.prototype.exchangeMode = function (value) {
    ...
    GambleSceneGuards.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneGuards;
}(GambleScene));
var BonusSceneGuards = (function (_super) {
    __extends(BonusSceneGuards, _super);
    function BonusSceneGuards() {
        var _this = this;
    ...
    BonusSceneGuards.prototype.initDisplay = function () {
    };
    BonusSceneGuards.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneGuards.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneGuards.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneGuards.prototype.selectBonus = function (nom) {
    ...
    BonusSceneGuards.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneGuards;
}(BonusScene));
var slotGuards = new SlotGuards();
mainSlot.setSlot(slotGuards);
//# sourceMappingURL=slot_guards.js.map