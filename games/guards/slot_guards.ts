class SlotGuards extends SlotEnity implements ISlotEnity {
...
class MainSceneGuards extends MainScene implements IMainScene {
...
class HelpSceneGuards extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneGuards extends GambleScene implements IGambleScene {
...
class BonusSceneGuards extends BonusScene implements IBonusScene {
...
//TO DO
var slotGuards: SlotGuards = new SlotGuards();
