class MainSlot {
    ...
    public callback(): void {
        let sp: PIXI.Sprite = new PIXI.Sprite(PIXI.loader.resources["fon_main_scene"].texture);
        let fon: PIXI.Sprite = new PIXI.Sprite(PIXI.loader.resources["fon_main_scene2"].texture);
        fon.anchor.x = 0.7;
        sp.anchor.x = 0.2;
        sp.addChild(fon);
    ...
    public resize() {
        ...
        this.renderer.view.style.width = (w / this.pixelRatio) + "px";
        this.renderer.view.style.height = (h / this.pixelRatio) + "px";    //this part adjusts the ratio:  
