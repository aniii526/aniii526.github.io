...
var SlotEnity = (function (_super) {
    ...
    function SlotEnity() {
        _super.call(this);
        this.currProcNumLoadedObj = 0;
        this.tempNumLoadedObj = 0;
    }
...
var MainScene = (function (_super) {
    ...
    MainScene.prototype.startSpin = function () {
...
var Rolls = (function (_super) {
    ...
    Rolls.prototype.startSpin = function () {
...
var Roll = (function (_super) {
    ...
    function Roll(nomRoll, rollVO) {
        ...
        this.rollElement = new Array();
        this.targetCombNew = [];
        this.countYForDeleteElement = 682.5;
        PIXI.ticker.shared.add(this._onTickEvent, this);
    }
    Roll.prototype.hide = function (index) {
        this.rollElement[index + 1].visible = false;
    };
    Roll.prototype.showAll = function () {
        var lenght = this.rollElement.length;
        for (var i = 0; i < lenght; i++) {
            this.rollElement[i].visible = true;
        }
    };
    Roll.prototype._onTickEvent = function (deltaTime) {
        if (this.pause == false) {
            var lenght = this.rollElement.length;
            for (var i = 0; i < lenght; i++) {
            ...
            if (this.currentState == Roll.END_STATE) {
                ...
                if (this.rollElement[lenght - 1].y > this.countYForDeleteElement) {
                    this.deleteLastElement();
                    var index = this.targetCombNew.pop();
                    if (index != -1)
    ...
    Roll.prototype.deleteLastElement = function () {
        var ic = this.rollElement[this.rollElement.length - 1];
    ...
    Roll.prototype.addNewElement = function (index) {
        var ic = this.getIcon(index);
        ic.y = -this.rollVO.step_y - (this.rollVO.step_y / 2);
        this.container.addChild(ic);
        this.rollElement.unshift(ic);
    };
    Roll.prototype.startSpin = function () {
    ...
    Roll.prototype.completeRoll = function () {
        for (var i = 0; i < this.rollElement.length; i++) {
