...
class LoadPanel extends Command {
    ...
    protected execInternal(): void {
        ...
        loadJS("panel/panel_slot_web.js?21", () => { this.completeLoadPanelJS() });
    }
...
class LoadSlot extends Command {
    ...
    protected execInternal(): void {
        ...
        if (url !== '') {
            loadJS(url + "?24", () => { this.completeLoadSlotJS(); });
        }
    }
...
class GameList {
    ...
    public static BUNCH: string = "134";
    public static BORA_BORA: string = "137";
    public static CRAZY_TALE: string = "140";
    public static ANIMALS: string = "143";
    public static ICE_AND_FIRE: string = "146";
    //public static NEXT_GAME: string = "149";
}
