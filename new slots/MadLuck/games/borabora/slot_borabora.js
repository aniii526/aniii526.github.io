...
var SlotBorabora = (function (_super) {
    __extends(SlotBorabora, _super);
    function SlotBorabora() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_GAMBLE_SCENE = 'games/gnome/images/gamble_card2.json';
        SlotEnity.NAME_ATLAS_ICONS = 'games/borabora/images/img_v2/game/iconsss.json';
    ...
    SlotBorabora.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'games/borabora/images/img_v2/game/mainback_Borabora.jpg?3')
            .add('double', 'games/borabora/images/img_v2/gamble/double.png?1')
            .add('help_bg', 'games/borabora/images/img_v2/help/help.png?1')
    ...
    SlotBorabora.prototype.onProgressCallback = function (e, r) {
    };
    SlotBorabora.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotBorabora.prototype.getSettingRoll = function () {
    ...
    SlotBorabora.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotBorabora.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneBorabora();
        return this.help;
    };
    SlotBorabora.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneBorabora();
        return this.gamble;
    };
    SlotBorabora.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneBorabora();
        return this.mainScene;
    };
    SlotBorabora.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotBorabora;
}(SlotEnity));
var MainSceneBorabora = (function (_super) {
    __extends(MainSceneBorabora, _super);
    function MainSceneBorabora() {
    ...
    MainSceneBorabora.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
        ...
        this.ar_btn = mainSlot.panel.panel.getBtnForLoop();
    };
    MainSceneBorabora.prototype.getAnimIconVOForId = function (id) {
        ...
        switch (id) {
            ...
            case 5:
                ...
                break;
            case 6:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_6_", 9);
            ...
            case 7:
                ...
                break;
            case 8:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_8_", 9);
                animIconVO.loop = false;
                animIconVO.anim_speed = 4 / 60;
                break;
            case 9:
                animIconVO.textures = mainSlot.getTexturesForName(SlotEnity.NAME_ATLAS_ICONS, "icon_9_", 9);
                animIconVO.loop = false;
                animIconVO.anim_speed = 4 / 60;
                break;
        }
    ...
    MainSceneBorabora.prototype.completeShowLines = function () {
    };
    MainSceneBorabora.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneBorabora.prototype.exchangeMode = function (value) {
    ...
    MainSceneBorabora.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneBorabora.prototype.updateBetLine = function (type) {
    ...
    MainSceneBorabora.prototype.updateShield = function () {
    ...
    MainSceneBorabora.prototype.getNumBonus = function () {
    ...
    return MainSceneBorabora;
}(MainScene));
var HelpSceneBorabora = (function (_super) {
    __extends(HelpSceneBorabora, _super);
    function HelpSceneBorabora() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneBorabora;
}(HelpScene));
var GambleSceneBorabora = (function (_super) {
    __extends(GambleSceneBorabora, _super);
    function GambleSceneBorabora() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneBorabora.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneBorabora.prototype.exchangeMode = function (value) {
    ...
    GambleSceneBorabora.prototype.showMsgDouble = function () {
        mainSlot.panel.panel.setTxtInfo("SELECT CARD OR START");
    };
    GambleSceneBorabora.prototype.setSelectValue = function (type) {
        _super.prototype.setSelectValue.call(this, type);
        this.pick_mc.x = this.mc["card" + type].x + 82;
        this.pick_mc.visible = true;
    };
    GambleSceneBorabora.prototype.resetGamble = function () {
        var _this = this;
    ...
    GambleSceneBorabora.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneBorabora;
}(GambleScene));
var BonusSceneBorabora = (function (_super) {
    __extends(BonusSceneBorabora, _super);
    function BonusSceneBorabora() {
        var _this = this;
    ...
    BonusSceneBorabora.prototype.initDisplay = function () {
    };
    BonusSceneBorabora.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneBorabora.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneBorabora.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneBorabora.prototype.selectBonus = function (nom) {
    ...
    BonusSceneBorabora.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneBorabora;
}(BonusScene));
var slotBorabora = new SlotBorabora();
mainSlot.setSlot(slotBorabora);
//# sourceMappingURL=slot_borabora.js.map