...
var PanelSlotWeb = (function (_super) {
    ...
    PanelSlotWeb.prototype.getTotalWin = function () {
        return this._txt_total_win;
    };
    PanelSlotWeb.prototype.getTFBalance = function () {
        return this._txt_balance;
    };
    ...
    PanelSlotWeb.prototype.getBtnForLoop = function () {
        return null;
    };
    return PanelSlotWeb;
}(PIXI.Sprite));
var PanelSlotMob = (function (_super) {
    ...
    PanelSlotMob.prototype.completeLoad = function () {
        ...
        this.btn_home.position.x = -51;
        this.btn_home.position.y = 113;
        ...
        this.btn_menu.position.x = -51;
        this.btn_menu.position.y = 567;
    ...
    PanelSlotMob.prototype.showhelp = function () {
        ...
        if (!this.btn_back_info) {
            ...
            this.btn_back_info.position.x = -51;
            this.btn_back_info.position.y = 567;
    ...
    PanelSlotMob.prototype.getBtnForLoop = function () {
        var ar = new Array();
        ar.push(this.start_spin);
        ar.push(this.btn_home);
        ar.push(this.btn_menu);
        return ar;
    };
    return PanelSlotMob;
}(PanelSlotWeb));
