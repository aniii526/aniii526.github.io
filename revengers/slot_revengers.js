...
var SlotRevengers = (function (_super) {
    __extends(SlotRevengers, _super);
    function SlotRevengers() {
        _super.call(this);
        SlotEnity.NAME_ATLAS_ICON = 'revengers/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_ICON_ANIM = 'revengers/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_HELP_SCENE = 'revengers/images/img_v2/game/prokrut_main/icon_main.json';
        SlotEnity.NAME_ATLAS_MAIN_SCENE = 'revengers/images/img_v2/game/prokrut_main/icon_main.json';
    ...
    SlotRevengers.prototype.getResourseImg = function (callback) {
        this.loader = PIXI.loader
            .add('mainback', 'revengers/images/img_v2/game/mainback_REvengers.jpg?2')
            .add('revengers/images/img_v2/game/prokrut_main/icon_main.json')
            .add('double', 'revengers/images/img_v2/gamble/double.jpg?1')
            .add('help_bg', 'revengers/images/img_v2/help/help.jpg?1')
            .add('help_scene_0', 'revengers/images/img_v2/help/help0.jpg?1')
            .add('help_scene_1', 'revengers/images/img_v2/help/help1.jpg?1')
            .add('help_scene_2', 'revengers/images/img_v2/help/help2.jpg?1')
    ...
    SlotRevengers.prototype.getStateSlotManager = function () {
        return new StateSlotManagerDefault();
    };
    SlotRevengers.prototype.getSettingRoll = function () {
    ...
    SlotRevengers.prototype.initGame = function () {
        mainSlot.panel.setBlockTypeBtn(ModelSlot.MODE_SUPERBONUS, new ModePanelShow([PanelEvent.AUTO, PanelEvent.BETONE, PanelEvent.MAXBET, PanelEvent.START], [1, 2, 3]));
    };
    SlotRevengers.prototype.getHelpScene = function () {
        if (this.help == null)
            this.help = new HelpSceneRevengers();
        return this.help;
    };
    SlotRevengers.prototype.getGambleScene = function () {
        if (this.gamble == null)
            this.gamble = new GambleSceneRevengers();
        return this.gamble;
    };
    SlotRevengers.prototype.getMainScene = function () {
        if (this.mainScene == null)
            this.mainScene = new MainSceneRevengers();
        return this.mainScene;
    };
    SlotRevengers.prototype.getIsShield = function () {
        return mainSlot.model.shield;
    };
    return SlotRevengers;
}(SlotEnity));
var MainSceneRevengers = (function (_super) {
    __extends(MainSceneRevengers, _super);
    function MainSceneRevengers() {
    ...
    MainSceneRevengers.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    MainSceneRevengers.prototype.getAnimIconVOForId = function (id) {
        return new AnimIconVO();
    };
    MainSceneRevengers.prototype.completeShowLines = function () {
    };
    MainSceneRevengers.prototype.onCompleteRolls = function () {
        _super.prototype.onCompleteRolls.call(this);
    };
    MainSceneRevengers.prototype.exchangeMode = function (value) {
    ...
    MainSceneRevengers.prototype.updateBalance = function (value) {
        mainSlot.panel.panel.setTxtBalance("" + value);
    };
    MainSceneRevengers.prototype.updateBetLine = function (type) {
    ...
    MainSceneRevengers.prototype.updateShield = function () {
    ...
    MainSceneRevengers.prototype.getNumBonus = function () {
    ...
    return MainSceneRevengers;
}(MainScene));
var HelpSceneRevengers = (function (_super) {
    __extends(HelpSceneRevengers, _super);
    function HelpSceneRevengers() {
        _super.call(this, new PIXI.Sprite());
    ...
    return HelpSceneRevengers;
}(HelpScene));
var GambleSceneRevengers = (function (_super) {
    __extends(GambleSceneRevengers, _super);
    function GambleSceneRevengers() {
        _super.call(this, new PIXI.Sprite());
        var mainback = new PIXI.Sprite(PIXI.loader.resources["mainback"].texture);
        mainback.x = -300;
        mainback.cacheAsBitmap = true;
    ...
    GambleSceneRevengers.prototype.initDisplay = function () {
        var _this = this;
        var styleLabelIndex = {
            align: 'left',
            fontSize: '17px',
    ...
    GambleSceneRevengers.prototype.exchangeMode = function (value) {
    ...
    GambleSceneRevengers.prototype.showMsgDouble = function () {
        mainSlot.panel.panel.setTxtInfo("SELECT CARD OR START");
    };
    GambleSceneRevengers.prototype.setSelectValue = function (type) {
        _super.prototype.setSelectValue.call(this, type);
        this.pick_mc.x = this.mc["card" + type].x + 82;
        this.pick_mc.visible = true;
    };
    GambleSceneRevengers.prototype.resetGamble = function () {
        var _this = this;
    ...
    GambleSceneRevengers.prototype.updatePrize = function () {
        mainSlot.panel.panel.setTxtTotalWin("" + this.modelSlot.lastAction.Summ);
    };
    return GambleSceneRevengers;
}(GambleScene));
var BonusSceneRevengers = (function (_super) {
    __extends(BonusSceneRevengers, _super);
    function BonusSceneRevengers() {
        var _this = this;
    ...
    BonusSceneRevengers.prototype.initDisplay = function () {
    };
    BonusSceneRevengers.prototype.onCompleteAnimation = function () {
    ...
    BonusSceneRevengers.prototype.resetBonus = function (summ, isSb, completeCallback) {
    ...
    BonusSceneRevengers.prototype.setPositionGnome = function (pos) {
    ...
    BonusSceneRevengers.prototype.selectBonus = function (nom) {
    ...
    BonusSceneRevengers.prototype.setBombForShield = function (isRand) {
    ...
    return BonusSceneRevengers;
}(BonusScene));
var slotRevengers = new SlotRevengers();
mainSlot.setSlot(slotRevengers);
//# sourceMappingURL=slot_revengers.js.map