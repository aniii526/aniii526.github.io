class SlotRevengers extends SlotEnity implements ISlotEnity {
...
class MainSceneRevengers extends MainScene implements IMainScene {
...
class HelpSceneRevengers extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneRevengers extends GambleScene implements IGambleScene {
...
class BonusSceneRevengers extends BonusScene implements IBonusScene {
...
//TO DO
var slotRevengers: SlotRevengers = new SlotRevengers();
