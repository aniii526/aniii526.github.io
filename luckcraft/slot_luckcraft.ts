class SlotLuckCraft extends SlotEnity implements ISlotEnity {
...
class MainSceneLuckCraft extends MainScene implements IMainScene {
...
class HelpSceneLuckCraft extends HelpScene implements IHelpScene {
    constructor() {
...
class GambleSceneLuckCraft extends GambleScene implements IGambleScene {
...
class BonusSceneLuckCraft extends BonusScene implements IBonusScene {
...
//TO DO
var slotLuckCraft: SlotLuckCraft = new SlotLuckCraft();
